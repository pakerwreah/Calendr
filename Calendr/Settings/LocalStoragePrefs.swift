...
enum Prefs {
    ...
    static let hiddenEventStatusItemTitleCalendars = "hidden_event_status_item_title_calendars"
    ...
    static let showFullScreenEvent = "event_status_item_full_screen"
    static let fullScreenEventTransparencyLevel = "full_screen_event_transparency_level"
    ...
    static let showMonthOutline = "show_month_outline"
    ...
    static let showAllDayEvents = "show_all_day_events"
...
func registerDefaultPrefs(
    ...
    localStorage.register(defaults: [
        ...
        Prefs.hiddenEventStatusItemTitleCalendars: [],
        ...
        Prefs.eventStatusItemNotchLength: 6,
...
extension LocalStorageProvider {
    ...
    @objc dynamic var hiddenEventStatusItemTitleCalendars: [String] {
        get { stringArray(forKey: Prefs.hiddenEventStatusItemTitleCalendars) ?? [] }
        set { set(newValue, forKey: Prefs.hiddenEventStatusItemTitleCalendars) }
    }
    ...
    @objc dynamic var showFullScreenEvent: Bool {
        get { bool(forKey: Prefs.showFullScreenEvent) }
        set { set(newValue, forKey: Prefs.showFullScreenEvent) }
    }

    @objc dynamic var fullScreenEventTransparencyLevel: Int {
        get { integer(forKey: Prefs.fullScreenEventTransparencyLevel) }
        set { set(newValue, forKey: Prefs.fullScreenEventTransparencyLevel) }
    }
    ...
    @objc dynamic var eventStatusItemNotchLength: Int {
        get { integer(forKey: Prefs.eventStatusItemNotchLength) }
        set { set(newValue, forKey: Prefs.eventStatusItemNotchLength) }
    }
    ...
    @objc dynamic var showMonthOutline: Bool {
        get { bool(forKey: Prefs.showMonthOutline) }
        set { set(newValue, forKey: Prefs.showMonthOutline) }
    }
    ...
    @objc dynamic var showAllDayEvents: Bool {
        get { bool(forKey: Prefs.showAllDayEvents) }
        set { set(newValue, forKey: Prefs.showAllDayEvents) }
    }
