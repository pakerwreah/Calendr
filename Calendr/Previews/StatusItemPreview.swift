...
struct StatusItemPreview: PreviewProvider {
    ...
    static let dateProvider = MockDateProvider(now: .make(year: 2024, month: 12, day: 30))
    ...
    static let settings = MockStatusItemSettings(
        showIcon: true, showDate: true, backgroundStyle: .opaque, iconStyle: .dayOfWeek, dateFormat: "MMM yyyy", showNextEvent: true, textScaling: 1.2
    )
