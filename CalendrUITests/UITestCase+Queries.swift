...
extension UITestCase {
    ...
    enum Calendar {
        ...
        static var title: XCUIElement { Main.view.staticTexts[Accessibility.Calendar.title] }
        static var prevBtn: XCUIElement { Main.view.buttons[Accessibility.Calendar.prevBtn] }
        static var resetBtn: XCUIElement { Main.view.buttons[Accessibility.Calendar.resetBtn] }
        static var nextBtn: XCUIElement { Main.view.buttons[Accessibility.Calendar.nextBtn] }
