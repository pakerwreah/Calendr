...
class EventEditorViewModelTests {
    ...
    func testViewModel_naturalLanguageTitle_setsTomorrowAtTwoPM(_ time: String) async {
        ...
        let viewModel = makeViewModel(naturalLanguageEventInputEnabled: true)
    ...
    @Test func testViewModel_naturalLanguageTitle_numericDateUsesDayFirstLocale() async {
        ...
        let viewModel = makeViewModel(dateProvider: dateProvider, naturalLanguageEventInputEnabled: true)
    ...
    @Test func testViewModel_naturalLanguageTitle_fuzzyMatchesCalendarAndCleansSavedTitle()  async{
        ...
        let viewModel = makeViewModel(calendarService: calendarService, naturalLanguageEventInputEnabled: true)
    ...
    @Test func testViewModel_naturalLanguageTitle_recognizesNoonAndMidnight() async {
        ...
        let noonViewModel = makeViewModel(naturalLanguageEventInputEnabled: true)
        ...
        let midnightViewModel = makeViewModel(naturalLanguageEventInputEnabled: true)
    ...
    @Test func testViewModel_naturalLanguageTitle_recognizesMorningAndEvening() async {
        ...
        let morningViewModel = makeViewModel(naturalLanguageEventInputEnabled: true)
        ...
        let eveningViewModel = makeViewModel(naturalLanguageEventInputEnabled: true)
    ...
    func makeViewModel(
        ...
        naturalLanguageEventInputEnabled: Bool = false,
