...
class CalendarExtensionTests: XCTestCase {
    ...
    private func make(day: Int, hour: Int = 0, minute: Int = 0, second: Int = 0) -> Date {
        return Calendar.current.date(from: .init(day: day, hour: hour, minute: minute, second: second))!
    }
}
